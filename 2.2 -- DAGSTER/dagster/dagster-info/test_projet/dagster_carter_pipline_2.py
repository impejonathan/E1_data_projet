...
@asset(key="1_Azure_Scrapy1", group_name="azure_tasks_2")
def execute_2_Scrapy(context: AssetExecutionContext):
    """
...
@asset(key="2_Azure_Count1", group_name="azure_tasks_2", ins={"upstream": AssetIn(key="1_Azure_Scrapy1")})
def execute_2_Count(context: AssetExecutionContext, upstream: bool):
    """
...
@asset(key="3_Azure_Nettoyage1", group_name="azure_tasks_2" , ins={"upstream": AssetIn(key="2_Azure_Count1")})
def execute_2_Nettoyage(context: AssetExecutionContext, upstream: bool):
    """
...
@asset(key="4_Azure_delete_doublon1", group_name="azure_tasks_2", ins={"upstream": AssetIn(key="3_Azure_Nettoyage1")})
def execute_2_delete_doublon(context: AssetExecutionContext, upstream: bool):
    """
...
@asset(key="5_Azure_changement_prix1", group_name="azure_tasks_2" , ins={"upstream": AssetIn(key="4_Azure_delete_doublon1")})
def execute_2_changement_prix(context: AssetExecutionContext, upstream: bool):
    """
...
@asset(key="6_Azure_ajouts_marque1", group_name="azure_tasks_2" , ins={"upstream": AssetIn(key="5_Azure_changement_prix1")})
def execute_2_ajouts_marque(context: AssetExecutionContext, upstream: bool):
    """
